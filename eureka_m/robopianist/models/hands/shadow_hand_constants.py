...
# Shadow hand XML files are in robopianist/third_party/mujoco_menagerie/shadow_hand/
# Navigate from models/hands/ to third_party/mujoco_menagerie/shadow_hand/
_SHADOW_HAND_DIR = _HERE.parent.parent / "third_party" / "mujoco_menagerie" / "shadow_hand"
