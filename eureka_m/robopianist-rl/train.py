...
def main(args: Args) -> None:
    ...
    for i in tqdm(range(1, args.max_steps + 1), disable=not args.tqdm_bar):
        ...
        if i >= args.warmstart_steps:
            if replay_buffer.is_ready():
                ...
                for _ in range(args.gradient_steps):
                    ...
                    agent, step_metrics = agent.update(transitions)
                    metrics = step_metrics
                if i % args.log_interval == 0 and args.mode != "disabled":
        ...
        if i % args.eval_interval == 0:
            ...
            if args.mode != "disabled":
                ...
                # Only delete video after successful wandb upload
                eval_env.latest_filename.unlink()
            # Videos are kept in eval folder when wandb is disabled
    ...
    final_checkpoint_path = experiment_dir / f"checkpoint_final.pkl"
